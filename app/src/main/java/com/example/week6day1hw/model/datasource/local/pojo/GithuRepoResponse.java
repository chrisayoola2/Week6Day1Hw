...
public class GithuRepoResponse implements Parcelable {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    public final static Parcelable.Creator<GithuRepoResponse> CREATOR = new Creator<GithuRepoResponse>() {


        @SuppressWarnings({
                "unchecked"
        })
        public GithuRepoResponse createFromParcel(Parcel in) {
            return new GithuRepoResponse(in);
        }

        public GithuRepoResponse[] newArray(int size) {
            return (new GithuRepoResponse[size]);
        }

    }
            ;

    protected GithuRepoResponse(Parcel in) {
